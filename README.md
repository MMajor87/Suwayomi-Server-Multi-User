...
- **Multi-user mode** — isolated library, reading progress, categories, and tracker records per user; JWT auth with refresh-token rotation and session revocation; admin user management panel
...
- [Suwayomi-WebUI](https://github.com/Suwayomi/Suwayomi-WebUI): Web app, PWA. *(This fork ships a multi-user-extended build of this UI as default - see [Multi-User Mode](#multi-user-mode) above.)*
...
- [Tachidesk-GTK](https://github.com/mahor1221/Tachidesk-GTK): Native Rust/GTK desktop client
- [Equinox](https://github.com/Suwayomi/Equinox): Web UI built with Vue.js
